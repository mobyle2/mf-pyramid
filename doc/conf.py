...
project = u'MingForm'
copyright = u'2012, Olivier Sallou'
...
latex_documents = [
  ('index', 'MingForm.tex', u'MingForm Documentation',
...
man_pages = [
    ('index', 'mingform', u'MingForm Documentation',
     [u'Olivier Sallou'], 1)
]
...
texinfo_documents = [
  ('index', 'MingForm', u'MingForm Documentation',
   u'Olivier Sallou', 'MingForm', 'One line description of project.',
   'Miscellaneous'),
]
